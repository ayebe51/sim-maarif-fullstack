        ...
        <Card className="max-w-md w-full border-red-200 shadow-lg">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-base mt-2">
              Data Anggota dengan NUPTK/ID <strong>{nuptk}</strong> tidak terdaftar dalam sistem Platform EduSaaS Kab. Pusat.
            </CardDescription>
          </CardHeader>
      ...
      <Card className="max-w-md w-full border-green-200 shadow-xl overflow-hidden relative">
        ...
        <CardHeader className="text-center pt-8 pb-4 bg-white">
          ...
          <CardDescription className="text-sm mt-1 text-emerald-600 font-medium bg-emerald-50 inline-block px-3 py-1 rounded-full">
            Anggota Aktif Platform EduSaaS
          </CardDescription>
        </CardHeader>
        <CardContent className="bg-slate-50/50 p-6">
            <div className="space-y-4">
               ...
               <div className="grid grid-cols-2 gap-4">
                   ...
                   <div>
                       <p className="text-xs text-slate-500 uppercase font-semibold tracking-wider mb-1">NIP / ID</p>
                       <p className="font-mono text-sm font-medium text-slate-700 bg-white border border-slate-200 px-2 py-1 rounded inline-block">{(teacher as any).nomorIndukPegawai || "-"}</p>
                   </div>
               </div>
               <div>
