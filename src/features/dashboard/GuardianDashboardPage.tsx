        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-100 relative overflow-hidden">
                ...
                <div className="flex items-center gap-5 relative z-10">
                    <div className="h-16 w-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl flex items-center justify-center text-white shadow-lg">
                        <User size={32} />
                    </div>
                    <div>
                        ...
                        <p className="text-slate-500 mt-1 flex items-center gap-2">
                            Selamat datang, <span className="font-bold text-blue-800">{user?.name || "Bapak/Ibu"}</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div className="flex flex-col space-y-1">
                                <span className="text-sm font-medium text-slate-500">Kehadiran Bulan Ini</span>
                ...
                <Card className="border-0 shadow-sm bg-white overflow-hidden rounded-2xl">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div className="flex flex-col space-y-1">
                                <span className="text-sm font-medium text-slate-500">Nilai Tahfidz Terakhir</span>
                                <span className="text-3xl font-extrabold text-emerald-800">A</span>
                            </div>
